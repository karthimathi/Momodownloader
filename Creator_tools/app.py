    ...
    try:
        ...
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            if 'instagram.com' in url.lower() or 'facebook.com' in url.lower() or 'fb.com' in url.lower() or 'fb.watch' in url.lower():
                ...
                return None, "Please provide Instagram or Facebook video links only"
...
def generate_title(action=None, topic=None):
    ...
    if action:
        title_data['action'] = action.lower()
        title_data['action_upper'] = action.upper()
    if topic:
        title_data['topic'] = topic
